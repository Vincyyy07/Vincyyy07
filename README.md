<h1 align="center">Hi 👋, I'm Raj Vincy Degapati</h1>
<h3 align="center">Front-End Developer | B.Tech CSE Student | Problem Solver</h3>
...
A highly enthusiastic and self-motivated student with a strong passion for continuous learning and exploration of new technologies.  
Eager to apply my skills, adaptability, and problem-solving abilities in a dynamic environment while gaining practical experience and contributing effectively.
...
- ⭐ 1-Star Coder on CodeChef (Max Rating: 1179)
- 💻 Active problem solver on LeetCode
- 🏅 HackerRank:
  - 5-Star in Problem Solving
  - 4-Star in C
  - 2-Star in C++
- 🧩 Solved 150+ problems on MayaPortal (College coding platform)
...
### 🎓 Workshops
- Practical Machine Learning – JNTU Vizianagaram
...
- Improving DSA daily
- Building mini IoT-based projects
- Strengthening front-end development skills
- Preparing for internships & real-world opportunities
